...
frontier should use the reduced local CLM path with the smaller trust boundary:
local reduced branch/sign-flip data -> `ReducedLocalAdjacentBoundaryCLMInvariant`
