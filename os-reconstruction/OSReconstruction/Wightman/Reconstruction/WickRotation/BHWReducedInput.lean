...
/-- Translation invariance on the absolute forward tube. The canonical input
producer proves this property before descending through the safe section. -/
...
/-- Canonical reduced input with the proved distributional boundary values. -/
