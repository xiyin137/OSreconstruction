...
1. `BHW.extendedTube_same_sourceGram_extendF_eq`: for `z,w ∈
   ...
   lemmas are strictly support for the common residual-frame theorem; they do
   not assert the maximal isotropic frame or the null-boost family.
